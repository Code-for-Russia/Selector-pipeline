...
from org.codeforrussia.selector.standardizers.election_layers import ElectionLevel, ElectionLocationType, ElectionType
...
class Standardizer(ABC):
    ...
    def __init__(self, schema_registry: StandardProtocolSchemaRegistry):
